...
-- Insert users, this can be used in server side in the future
INSERT INTO
  central.Users (role, username, password)
VALUES
  ('customer', 'elias', 'koira123', 'Elias Peltonen'),
  ('admin', NULL, 'admin', 'admin', 'Ylläpitäjä')
RETURNING
  userId,
  role,
  username